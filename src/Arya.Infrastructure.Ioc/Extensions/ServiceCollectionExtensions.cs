...
namespace Arya.Infrastructure.Ioc.Extensions
{
    ...
    {
        public static void InitializeMySqlDataBase<T>(this IServiceCollection services, string connectionString) where T : DbContext
        {
        ...
        public static void AddEmail(this IServiceCollection services, string sendGridKey)
        {
            services.AddSingleton<IEmailService>(x => new EmailService(sendGridKey));
        }
    }
}
